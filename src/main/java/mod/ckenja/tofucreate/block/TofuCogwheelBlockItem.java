...
public class TofuCogwheelBlockItem extends BlockItem {
    ...
    public TofuCogwheelBlockItem(TofuCogWheelBlock block, Properties builder) {
        super(block, builder);
        large = block.isLargeCog();

        placementHelperId = PlacementHelpers.register(large ? new TofuCogwheelBlockItem.LargeCogHelper() : new TofuCogwheelBlockItem.SmallCogHelper());
        integratedCogHelperId =
                PlacementHelpers.register(large ? new TofuCogwheelBlockItem.IntegratedLargeCogHelper() : new TofuCogwheelBlockItem.IntegratedSmallCogHelper());
    }
