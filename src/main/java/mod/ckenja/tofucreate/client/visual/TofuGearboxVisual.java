...
public class TofuGearboxVisual extends KineticBlockEntityVisual<GearboxBlockEntity> {

    protected final EnumMap<Direction, RotatingInstance> keys = new EnumMap<>(Direction.class);
    protected Direction sourceFacing;

    public TofuGearboxVisual(VisualizationContext context, GearboxBlockEntity blockEntity, float partialTick) {
        ...
        var instancer = instancerProvider().instancer(AllInstanceTypes.ROTATING, Models.partial(ModAllPartialModels.SHAFT_HALF));
