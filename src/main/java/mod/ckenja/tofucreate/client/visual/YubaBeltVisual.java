...
public class YubaBeltVisual extends KineticBlockEntityVisual<BeltBlockEntity> {
    ...
    public YubaBeltVisual(VisualizationContext context, BeltBlockEntity blockEntity, float partialTick) {
        ...
        for (boolean bottom : Iterate.trueAndFalse) {
            PartialModel beltPartial = YubaBeltRenderer.getBeltPartial(diagonal, start, end, bottom);
            SpriteShiftEntry spriteShift = YubaBeltRenderer.getSpriteShiftEntry(color, diagonal, bottom);
        ...
        if (blockEntity.hasPulley()) {
            ...
            pulley.setup(YubaBeltVisual.this.blockEntity)
    ...
    public void update(float pt) {
        ...
        for (ScrollInstance key : belts) {
            setup(key, bottom, YubaBeltRenderer.getSpriteShiftEntry(color, diagonal, bottom));
            bottom = false;
        }
