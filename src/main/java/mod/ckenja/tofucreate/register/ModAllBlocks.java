...
public class ModAllBlocks {
    ...
    public static final BlockEntry<TofuEncasedCogwheelBlock> TOFU_ENCASED_COGWHEEL = TofuCreate.registrate
            ...
            .blockstate((ctx, prov) -> prov.getVariantBuilder(ctx.get())
                .forAllStates(state -> ConfiguredModel.builder()
                    .modelFile(prov.models().getExistingFile(prov.modLoc("block/tofu_encased_cogwheel")))
                    .build()))
            .register();
    public static final BlockEntry<TofuEncasedCogwheelBlock> TOFU_ENCASED_LARGE_COGWHEEL = TofuCreate.registrate
            ...
            .blockstate((ctx, prov) -> prov.getVariantBuilder(ctx.get())
                .forAllStates(state -> ConfiguredModel.builder()
                    .modelFile(prov.models().getExistingFile(prov.modLoc("block/tofu_encased_large_cogwheel")))
                    .build()))
            .register();
    ...
    public static final BlockEntry<TofuWaterWheelBlock> TOFU_WATER_WHEEL = TofuCreate.registrate.block("tofu_water_wheel", TofuWaterWheelBlock::new)
            ...
            .addLayer(() -> RenderType::cutoutMipped) // need change: Set your render type in your block model's JSON (eg. "render_type": "cutout_mipped")
    ...
    public static final BlockEntry<YubaBeltBlock> YUBA = TofuCreate.registrate.block("yuba", YubaBeltBlock::new)
            ...
            .addLayer(() -> RenderType::cutoutMipped) // need change
            .transform(axeOrPickaxe())
