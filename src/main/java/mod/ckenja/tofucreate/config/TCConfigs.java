...
public class TCConfigs {
    ...
    private static TCCommon common;

    public static TCCommon common() {
        return common;
    }
    ...
    public static void register(ModLoadingContext modLoadingContext) {
        common = register(TCCommon::new, ModConfig.Type.COMMON);
        for (Entry<ModConfig.Type, ConfigBase> pair : CONFIGS.entrySet())
            modLoadingContext.registerConfig(pair.getKey(), pair.getValue().specification);
