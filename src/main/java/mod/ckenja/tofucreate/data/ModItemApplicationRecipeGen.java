...
public class ModItemApplicationRecipeGen extends ProcessingRecipeGen {
    ...
    protected GeneratedRecipe woodCasingIngredient(String type, Supplier<Ingredient> ingredient,
        ...
        create(ResourceLocation.fromNamespaceAndPath(TofuCreate.MODID, type + "_casing_from_log"), b -> b.require(AllItemTags.STRIPPED_LOGS.tag)
                .require(ingredient.get())
                .output(output.get()));
        return create(ResourceLocation.fromNamespaceAndPath(TofuCreate.MODID, type + "_casing_from_wood"), b -> b.require(AllItemTags.STRIPPED_WOOD.tag)
                .require(ingredient.get())
                .output(output.get()));
    }

    public ModItemApplicationRecipeGen(PackOutput output) {
